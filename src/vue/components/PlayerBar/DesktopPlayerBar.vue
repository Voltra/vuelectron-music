	...
	<nav class="desktopPlayerBar">
		<div class="_part -side -left">
			<button class="material-icons"
					@click="playlistController.playSequentiallyPrev">
				navigate_before
			</button>

			<button class="material-icons -play"
					@click="playlistController.togglePlay">
				{{ playIcon }}
			</button>

			<button class="material-icons"
					@click="playlistController.playSequentiallyNext">
				navigate_next
			</button>
		</div>
		...
		<div class="_part -side -right">
			...
			<button class="material-icons -volume"
					@click="playlistController.toggleMute">
...
import PlayerProgressBar
	from "@/vue/components/PlayerBar/PlayerProgressBar.vue";
...
} from "@/js/modules/player/usePlaylistController.ts";
