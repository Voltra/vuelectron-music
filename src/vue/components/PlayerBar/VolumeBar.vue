<template>
	<div ref="wrapper" class="playerVolumeBar" @mouseleave="endDrag"
		 @mouseup="onMouseUp">
		<div ref="rail" class="_rail" @click="onMouseEvent">
			<div ref="progress" :style="styles" class="_progress"
				 @mousedown="onMouseDown" @mouseup="onMouseUp">
				<div ref="thumb" class="_thumb" @mousedown="onMouseDown"
					 @mouseup="onMouseUp"></div>
			</div>


			<div ref="tooltip" :style="tooltipStyles" class="_tooltip">
			<span>
				{{ tooltipText }}
			</span>
				<span ref="tooltipArrow" class="_tooltipArrow"></span>
			</div>
		</div>
	</div>
</template>
